...
import maniteja from "/agrimart.png";
      ...
      <div className="container mx-auto px-20 pt-16">
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          >
            ...
            >
              <span className="text-purple-500">AI/ML Developer</span> | Creative
              Technologist
            </motion.h2>
            <motion.p
            ...
            >
              I build intelligent, data-driven solutions using Machine Learning,
               Deep Learning, and NLP. With hands-on experience in AI projects and
                an internship at Infosys, I transform real-world problems into smart 
                applications. Passionate about learning, I thrive on innovation, teamwork,
                 and turning ideas into impactful, efficient technologies.
            </motion.p>
