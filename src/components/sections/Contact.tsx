...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const whatsAppURL = `https://wa.me/919346012077?text=${encodeURIComponent(
      whatsAppMessage
    )}`;
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="mailto:aksharraodeshaveni2004@gmail.com"
                      className="text-white hover:text-purple-400 transition-colors"
                    >
                      aksharraodeshaveni2004@gmail.com
                    </a>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    ...
                    <a
                      href="https://wa.me/919346012077" // Replace this with your actual phone number for WhatsApp
                      className="text-white hover:text-purple-400 transition-colors"
                    >
                      +91 9346012077
                    </a>
